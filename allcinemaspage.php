...
<script>
       ...
       function cinemagrid(cinema_name,poster_movie,m_id){
    document.getElementById("generation").innerHTML+=
    `<div class="movie-item-style-2 movie-item-style-1">
							<img src=`+poster_movie+` alt="">
							<div class="hvr-inner">
	            			 <a href="SingleCinemaPage.php?id=`+m_id+`"> Book Now <i class="ion-android-arrow-dropright"></i> </a>
	            			</div>
							<div class="mv-item-infor">
								<h6 ><a href="#">`+cinema_name+`</a></h6>
...
<div class="page-single">
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="flex-wrap-movielist mv-grid-fw" id="generation">
				</div>		
	...
	<script src="js/custom.js"></script>
     ...
     <?php require "allcinemaspagephp.php";?>
     
    <?php
    initializeData();
    ?> 
    <!-- <script type="text/javascript"> cinemagrid("SSSSSSSS","images/1.jpg","1"); </script> -->
