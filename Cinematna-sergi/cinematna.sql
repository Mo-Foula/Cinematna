...
INSERT INTO `movie` (`movie_id`, `movie_name`, `movie_des`, `movie_rate`, `movie_poster`, `movie_3d`, `movie_foreign`) VALUES
(1, 'Deadpool', 'Deadpool is a highly trained assassin and mercenary. He is adept in multiple forms of martial arts, including Savate. Deadpool is an extraordinary athlete, and an expert swordsman and marksman. He is skilled in the use of multiple weapons, including katanas, knives, grenades, and guns.', 8, 'img/Deadpool.jpg', 0, 1),
(2, 'The Hurricane Heist', 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.\r\n\r\nNemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.\r\n\r\nUt enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.\r\n\r\nUt enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.', 7.9, 'img/TheHurricaneHeist.jpg', 1, 1),
(3, 'The Old Guard', 'A covert team of immortal mercenaries is suddenly exposed and must now fight to keep their identity a secret just as an unexpected new member is discovered.', 6.6, 'img/TheOldGuard.jpg', 0, 1);
...
INSERT INTO `party` (`party_id`, `movie_id`, `hall_id`, `cinema_id`, `party_time`, `party_price`, `party_start`, `party_end`) VALUES
(1, 1, 1, 1, 90, 150, '2020-12-28 16:15:23', '2020-12-28 18:13:45'),
(2, 2, 1, 1, 90, 150, '2021-01-06 10:57:24', '2021-01-07 10:56:51');
...
CREATE TABLE `row` (
  ...
  `row_vacant` tinyint(1) NOT NULL COMMENT 'if it is a hallway'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `row` (`row_id`, `hall_id`, `cinema_id`, `row_vacant`) VALUES
(1, 3, 1, 0);
...
CREATE TABLE `seat` (
  ...
  `cinema_id` int(11) NOT NULL COMMENT 'e7tyaty',
  `row_id` int(11) NOT NULL,
  `seat_vacant` tinyint(1) NOT NULL,
  `seat_occupied` tinyint(1) NOT NULL,
...
INSERT INTO `seat` (`seat_id`, `cinema_id`, `row_id`, `seat_vacant`, `seat_occupied`, `hall_id`) VALUES
(1, 1, 1, 0, 0, 3);
...
INSERT INTO `ticket` (`ticket_id`, `user_id`, `party_id`, `seat_id`, `qr`, `randomInt`) VALUES
(0, 0, 1, 1, 'temp', 0),
(0, 0, 2, 1, '', 0);
...
ALTER TABLE `seat`
  ...
  ADD CONSTRAINT `row_seat_id` FOREIGN KEY (`row_id`) REFERENCES `row` (`row_id`);
