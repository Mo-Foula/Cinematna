function setMovieName(MovieName, year, rate, poster, description, runTime, MovieTrailer, id) {
	...
	btns = document.getElementsByClassName('linkonmodal');
	for (var i = 0; i < btns.length; i++){
		btns[i].href = "modalpage.php?id="+id;
	}
}
