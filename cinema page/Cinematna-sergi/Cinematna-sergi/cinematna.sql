...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2020 at 05:19 PM
...
(3, 'The Old Guard', 'A covert team of immortal mercenaries is suddenly exposed and must now fight to keep their identity a secret just as an unexpected new member is discovered.', 6.6, 'The Old Guard.jpg', 0, 1);
...
ALTER TABLE `row`
  ...
  ADD CONSTRAINT `row_hall_id` FOREIGN KEY (`row_id`) REFERENCES `hall` (`hall_id`) ON DELETE CASCADE ON UPDATE CASCADE;
